...
- [`deal-structures.md`](deal-structures.md) — Comparison of deal types and artist economics
- [`sources.md`](sources.md) — Full source bibliography with confidence ratings

---

## Source Methodology

All data in this report is drawn from publicly available sources: RIAA published reports, SEC filings, court decisions, Congressional records, and established journalism. Where a claim could only be verified from a single source, it is explicitly flagged with a `[single-source]` notation. No data has been fabricated or estimated without disclosure.
